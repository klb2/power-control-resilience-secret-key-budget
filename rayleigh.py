...
if __name__ == "__main__":
    ...
    # plt.hist(skg, bins=200, density=True)
    # plt.plot(s, pdf_skg_rate_rayleigh(s, lam_x, lam_y), c='orange')
    # plt.plot(s, np.exp(logpdf_skg_rate_rayleigh(s, lam_x, lam_y)), '--', c='green')

    # plt.figure()
    # plt.hist(skg, bins=200, density=True, cumulative=True)
    # plt.plot(s, cdf_skg_rate_rayleigh(s, lam_x, lam_y), c='orange')
    # plt.plot(s, sf_skg_rate_rayleigh(s, lam_x, lam_y), c='orange', ls='--')
